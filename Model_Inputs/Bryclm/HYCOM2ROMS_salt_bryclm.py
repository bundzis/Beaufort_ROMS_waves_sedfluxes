...
# # salinity
# hycom_salt_3 = xr.open_dataset('/scratch/summit/brun1463/ROMS_scratch/Kakak3_scratch/External_data/HYCOM_2019_AprJul_salinity.nc4') # UPDATE PATH
# hycom_salt_4 = xr.open_dataset('/scratch/summit/brun1463/ROMS_scratch/Kakak3_scratch/External_data/HYCOM_2019_JulOct_salinity.nc4') # UPDATE PATH
# hycom_salt_5 = xr.open_dataset('/scratch/summit/brun1463/ROMS_scratch/Kakak3_scratch/External_data/HYCOM_2019_OctDec_salinity.nc4') # UPDATE PATH

# # Merge the different salt time periods into one dataset; takes ~ minutes
# hycom_salt_all = xr.merge([hycom_salt_3, hycom_salt_4, hycom_salt_5]) #(time, depth, lat, lon) 
# #print('done merging data')

# # Delete hycom_salt_3-5 right after merge to clear up memory
# # delete u files
# del(hycom_salt_3)
# del(hycom_salt_4)
# del(hycom_salt_5)
...
# #print(hycom_salt_3.dims)
# #print(hycom_salt_4.dims)
# #print(hycom_salt_5.dims)

# Load in the HYCOM salinity data
hycom_salt_all = xr.open_dataset('/scratch/alpine/brun1463/ROMS_scratch/Kakak3_Alpine_2020_scratch/Final_bryclm_conds/Input_data/HYCOM_2020_salinity_nogaps.nc4')
...
vert_salt_clm = '/scratch/alpine/brun1463/ROMS_scratch/Kakak3_Alpine_2020_scratch/Final_bryclm_conds/Attempt001/salt_clm_001.nc'   #UPDATE PATH
...
#name of file I am writing to
vert_salt_bry = '/scratch/alpine/brun1463/ROMS_scratch/Kakak3_Alpine_2020_scratch/Final_bryclm_conds/Attempt001/salt_bry_001.nc'  #UPDATE PATH
