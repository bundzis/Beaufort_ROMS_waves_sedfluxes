...
export   COAWST_APPLICATION=KAKTOVIK_AK_2020
...
export   MY_PROJECT_DIR=${MY_ROOT_DIR}/Kakak3_Alpine_2020
...
#   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Projects/Inlet_test/Coupled
   export MY_HEADER_DIR=${MY_PROJECT_DIR}/Kaktovik_ak_2020
   export MY_ANALYTICAL_DIR=${MY_PROJECT_DIR}/Kaktovik_ak_2020
